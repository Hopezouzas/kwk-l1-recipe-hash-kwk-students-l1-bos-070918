...
perfect_10_recipe = {
  ...
  "mini dark chocolate chips" => "3/4 cups",
  "olive oil" => "1/2 cup",
  "agave" => "1/4 cup"
...
perfect_10_recipe.each do |ingredients, measurements|
  puts "You need #{ingredients} and #{measurements}"
  puts ""
end 
...
def amount_of_chocolate_chips(perfect_10_recipe)
  amount_of_chocolate_chips = perfect_10_recipe["mini dark chocolate chips"]
  return amount_of_chocolate_chips
end
...
# 5: Now use `puts` to print out just the amounts without the ingredients. You'll want to use the `each_value` method.
 ...
 def amounts(perfect_10_recipe)
   perfect_10_recipe.each_value do |measurements|
  puts "#{measurements}"
end
end
